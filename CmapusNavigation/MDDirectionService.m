...
// the class implemented by Mano Marks from Google Maps SDK offcial website.
...
// set Direction query to Google Maps API with parameters of the orgin, the destination and directions type.
// iteratevely request Google Maps API to get each waypoint from the orgin to the destination
